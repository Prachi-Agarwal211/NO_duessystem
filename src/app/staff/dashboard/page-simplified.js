...
export default function StaffDashboard() {
  ...
  useEffect(() => {
    fetchDashboard();
    const channel = supabase.channel('staff_updates')
    ...
    <PageWrapper>
      <div className="p-4 md:p-8 max-w-7xl mx-auto min-h-screen">
        <div className="flex justify-between items-center mb-8">
          ...
          <button onClick={() => {setLoading(true); fetchDashboard();}} className="p-2 bg-white/10 rounded-lg hover:bg-white/20 text-white transition-all">
        ...
        <div className="mb-6 relative">
             ...
             <input 
                ...
                className="w-full md:w-96 pl-10 pr-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                {filtered.length === 0 ? (
                    ...
                    filtered.map((item) => (
                      ...
                      >
                        ...
                        <td className="p-4 font-mono text-sm text-gray-400">{item.no_dues_forms.registration_no}</td>
