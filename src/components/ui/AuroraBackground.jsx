...
export default function AuroraBackground({ className = '', children }) {
  ...
  return (
    <div className={`relative flex flex-col w-full min-h-screen overflow-x-hidden ${className}`}>
      {/* Background Layer - FIXED POSITION, NO SCROLL */}
      <div
      ...
      {/* Content Layer - ABOVE background, scrollable */}
      <div
