...
export default function Button({
    ...
    const variants = {
        ...
        secondary: 'bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-2 border-jecrc-red/50 dark:border-jecrc-red/60 hover:bg-gray-50 dark:hover:bg-gray-600 shadow-sm hover:shadow-md',
