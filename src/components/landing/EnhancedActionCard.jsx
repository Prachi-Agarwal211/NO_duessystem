  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p
          className={`font-sans text-sm sm:text-base font-medium leading-relaxed transition-all duration-300 ${
            isDark ? 'text-gray-200 group-hover:text-white' : 'text-gray-600 group-hover:text-gray-800'
          }`}
          style={isDark ? {
      ...
      <motion.div
        className={`relative z-10 flex items-center gap-3 text-xs font-bold tracking-[0.25em] uppercase transition-all duration-300 ${
          isDark
