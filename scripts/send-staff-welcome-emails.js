...
const ALL_STAFF = [
  ...
  { email: 'ashokh.singh@jecrcu.edu.in', name: 'Ashokh Singh', department: 'Registrar', type: 'Department Staff' },
  { email: 'mohit.badgujar@jecrcu.edu.in', name: 'Mohit Badgujar', department: 'Alumni Cell', type: 'Department Staff' },
  { email: 'yogesh.jhoshi@jecrcu.edu.in', name: 'Yogesh Jhoshi', department: 'Accounts', type: 'Department Staff' },
...
function getEmailHTML(staff) {
  const loginURL = 'https://no-duessystem.vercel.app/staff/login';
  const forgotPasswordURL = 'https://no-duessystem.vercel.app/staff/forgot-password';
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Welcome to the JECRC No Dues Management System! Your account has been successfully created.</p>
      ...
      <div style="background: #e3f2fd; border-left: 4px solid #2196F3; padding: 15px; margin: 20px 0;">
        <h4 style="margin-top: 0; color: #1976D2;">💡 After Changing Your Password:</h4>
        <p>Login to the system using your new credentials at:</p>
...
Welcome to the JECRC No Dues Management System! Your account has been successfully created.
...
Login to the system at: ${loginURL}
...
async function sendAllWelcomeEmails() {
  ...
  if (results.sent.length > 0) {
    ...
    console.log('• Password reset URL: https://no-duessystem.vercel.app/staff/forgot-password');
    console.log('• Staff login URL: https://no-duessystem.vercel.app/staff/login');
    console.log('─'.repeat(70));
  }
}
