-- ============================================================================
-- JECRC UNIVERSITY - COMPLETE COURSE DATA SEED (FIXED FOR SUPABASE)
-- ============================================================================
-- This is a corrected version that works with the existing database schema
-- Removed 'level' column references that were causing SQL errors
-- Compatible with COMPLETE_DATABASE_SETUP.sql schema
-- ============================================================================
...
-- ============================================================================
-- SECTION 2: SEED COURSES AND BRANCHES BY SCHOOL (FIXED)
-- ============================================================================
...
-- B.Tech Programs (UG) - FIXED: Removed level column
...
-- M.Tech Programs (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'School of Engineering & Technology'),
    'M.Tech',
...
-- BCA Programs (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- MCA Programs (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'School of Computer Applications'),
    'MCA',
...
-- BBA Programs (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- B.Com Programs (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'Jaipur School of Business'),
    'B.Com',
...
-- MBA Programs (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'Jaipur School of Business'),
    'MBA',
...
-- B.Sc (Hons.) Programs - 4 Years (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- M.Sc Programs (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'School of Sciences'),
    'M.Sc',
...
-- B.A. (Hons.) Programs - 4 Years (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- B.A. Liberal Studies (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'School of Humanities & Social Sciences'),
    'B.A. Liberal Studies',
...
-- M.A. Programs (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'School of Humanities & Social Sciences'),
    'M.A.',
...
-- Integrated Law Programs (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- LL.M Programs (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'School of Law'),
    'LL.M - 2 Years',
...
-- B.A. Journalism & Mass Communication (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- M.A. Journalism & Mass Communication (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'Jaipur School of Mass Communication'),
...
-- Bachelor of Visual Arts (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- B.Des Programs (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'Jaipur School of Design'),
    'B.Des - 4 Years',
...
-- Masters of Visual Arts (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'Jaipur School of Design'),
...
-- M.Des Programs (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'Jaipur School of Design'),
    'M.Des',
...
-- M.Sc Design Programs (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'Jaipur School of Design'),
    'M.Sc (Design)',
...
-- B.A. (Hons.) Economics (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- M.A. Economics (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'Jaipur School of Economics'),
    'M.A. Economics',
...
-- Bachelor of Physiotherapy (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- Master of Physiotherapy (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
    (SELECT id FROM public.config_schools WHERE name = 'School of Allied Health Sciences'),
...
-- B.Sc. Hospitality and Hotel Management (UG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- MBA Hospital and Healthcare Management (PG) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- Ph.D. Programs across all disciplines (PhD) - FIXED: Removed level column
INSERT INTO public.config_courses (school_id, name, display_order, is_active)
SELECT
...
-- ============================================================================
-- DATA SEED COMPLETE! (FIXED VERSION)
-- ============================================================================
-- Schools: 13
-- Courses: ~40+ (now compatible with schema)
-- Branches: ~200+
-- Total Programs: ~200+ across all levels
-- All INSERT statements now use the correct schema without 'level' column
-- ============================================================================